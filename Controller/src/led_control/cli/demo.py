...
def run_all_animations(brightness):
    ...
    print("Weather: clear")
    runner.run_weather_animation({"weather": [{"main": "Clear"}]}, duration_sec=5, brightness=brightness)
    print("Weather: clouds")
    runner.run_weather_animation({"weather": [{"main": "Clouds"}]}, duration_sec=5, brightness=brightness)
    print("Weather: rain")
    runner.run_weather_animation({"weather": [{"main": "Rain"}]}, duration_sec=5, brightness=brightness)
    print("Weather: drizzle")
    runner.run_weather_animation({"weather": [{"main": "Drizzle"}]}, duration_sec=5, brightness=brightness)
    print("Weather: snow")
    runner.run_weather_animation({"weather": [{"main": "Snow"}]}, duration_sec=5, brightness=brightness)
    print("Weather: thunderstorm")
    runner.run_weather_animation({"weather": [{"main": "Thunderstorm"}]}, duration_sec=5, brightness=brightness)
    print("Weather: fog")
    runner.run_weather_animation({"weather": [{"main": "Fog"}]}, duration_sec=5, brightness=brightness)
    print("Weather: unknown")
    runner.run_weather_animation({"weather": [{"main": "Unknown"}]}, duration_sec=5, brightness=brightness)
