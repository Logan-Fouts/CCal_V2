"""Unit tests for the main module of CCal_V2 LED control."""
...
@patch("main.LedUtils")
@patch("main.GithubTracker")
@patch("main.WeatherTracker")
...
def test_main_missing_required_config(mock_config_mgr):
    """Test main exits if required weather config is missing."""
...
def test_main_config_load_error(mock_config_mgr):
    """Test main exits if config manager initialization fails."""
