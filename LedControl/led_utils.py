...
class LedUtils:
    """Utility class for controlling NeoPixel LEDs."""
    ...
    def __init__(
        ...
        if pin_num == 18:
            ...
            raise ValueError(
                "Only GPIO18 supported by default. Update mapping for other pins."
            )
    ...
    def update_leds_for_events(self, event_counts):
        """Update LEDs for events, scaling brightness by event count."""
    ...
    def show_weather(self, weather_status, brightness=None, duration_sec=5):
        ...
        Args:
            ...
            brightness (float): Overall brightness scaling (0.0-1.0, defaults to instance brightness)
        """
        if brightness is None:
            brightness = self.brightness
